...
<p>Getters and setters are property decorators, which allow programmers to read and update the attributes of a specific instance of an object in a controlled way.</p>
...
<span class="c1"># Create a table in the database using SQL commands</span>
<span class="n">cursor</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="s1">&#39;&#39;&#39;CREATE TABLE restaurant_table</span>
<span class="s1">                 (id INTEGER PRIMARY KEY, name TEXT, address TEXT, rating REAL)&#39;&#39;&#39;</span><span class="p">)</span>

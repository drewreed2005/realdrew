...
<span class="o">&lt;</span><span class="n">h5</span> <span class="nb">id</span><span class="o">=</span><span class="s2">&quot;taskinput&quot;</span> <span class="n">style</span><span class="o">=</span><span class="s2">&quot;transform:translate(+700px, -60px);width:23%&quot;</span><span class="o">&gt;</span>
  <span class="o">&lt;</span><span class="err">!</span><span class="o">--</span><span class="n">TASK</span> <span class="n">INPUT</span> <span class="n">BOX</span> <span class="n">GOES</span> <span class="n">HERE</span><span class="o">--&gt;</span>
...
<span class="n">let</span> <span class="n">notifintv</span> <span class="o">=</span> <span class="n">Number</span><span class="p">(</span><span class="n">nintvinp</span><span class="o">.</span><span class="n">value</span><span class="p">);</span>
...
<span class="n">var</span> <span class="n">taskslen</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<span class="n">var</span> <span class="n">tasklist</span> <span class="o">=</span> <span class="p">[];</span> <span class="o">//</span> <span class="n">Add</span> <span class="n">failsafe</span> <span class="o">****</span>
...
<span class="n">var</span> <span class="n">ntaskinphtml</span> <span class="o">=</span> <span class="s1">&#39;&lt;label&gt;Task Info&lt;br&gt;&lt;/label&gt;&lt;br&gt;Task Name: &lt;input id=&quot;tnameinput0&quot; style=&quot;text-align:left&quot; type=&quot;text&quot; minlength=&quot;1&quot; value=&quot;My Task&quot;&gt;&lt;/input&gt;&lt;br&gt;Task Duration: &lt;input id=&quot;tdurinput0&quot; style=&quot;text-align:left&quot; type=&quot;number&quot; min=&quot;1&quot; minlength=&quot;1&quot; max=&quot;999&quot; value=&quot;45&quot;&gt;&amp;nbspminutes&lt;br&gt;&#39;</span>
<span class="n">var</span> <span class="n">ntaskbtnhtml</span> <span class="o">=</span> <span class="s1">&#39;&lt;button id=&quot;newtask&quot; class=&quot;newtask&quot;&gt;New Task&lt;/button&gt;&#39;</span><span class="p">;</span>
<span class="n">var</span> <span class="n">defaultTaskInp</span> <span class="o">=</span> <span class="n">ntaskinphtml</span> <span class="o">+</span> <span class="n">ntaskbtnhtml</span><span class="p">;</span>
<span class="n">taskInp</span><span class="o">.</span><span class="n">innerHTML</span> <span class="o">=</span> <span class="n">defaultTaskInp</span><span class="p">;</span>
<span class="n">function</span> <span class="n">moretaskrows</span><span class="p">()</span> <span class="p">{</span>
  <span class="n">taskslen</span> <span class="o">+=</span> <span class="mi">1</span><span class="p">;</span>
  <span class="n">console</span><span class="o">.</span><span class="n">log</span><span class="p">(</span><span class="n">taskslen</span><span class="p">);</span>
  <span class="n">ntaskinphtml</span> <span class="o">=</span> <span class="n">ntaskinphtml</span> <span class="o">+</span> <span class="s1">&#39;&lt;br&gt;Task Name: &lt;input id=&quot;tnameinput&#39;</span> <span class="o">+</span> <span class="n">String</span><span class="p">(</span><span class="n">taskslen</span><span class="p">)</span> <span class="o">+</span> <span class="s1">&#39;&quot; style=&quot;text-align:left&quot; type=&quot;text&quot; minlength=&quot;1&quot; value=&quot;My Task&quot;&gt;&lt;/input&gt;&lt;br&gt;Task Duration: &lt;input id=&quot;tdurinput&#39;</span> <span class="o">+</span> <span class="n">String</span><span class="p">(</span><span class="n">taskslen</span><span class="p">)</span> <span class="o">+</span> <span class="s1">&#39;&quot; style=&quot;text-align:left&quot; type=&quot;number&quot; min=&quot;1&quot; minlength=&quot;1&quot; max=&quot;999&quot; value=&quot;45&quot;&gt;&amp;nbspminutes&lt;br&gt;&#39;</span><span class="p">;</span>
  <span class="n">console</span><span class="o">.</span><span class="n">log</span><span class="p">(</span><span class="n">ntaskinphtml</span><span class="p">);</span>
  <span class="n">defaultTaskInp</span> <span class="o">=</span> <span class="n">ntaskinphtml</span> <span class="o">+</span> <span class="n">ntaskbtnhtml</span><span class="p">;</span>
  <span class="n">taskInp</span><span class="o">.</span><span class="n">innerHTML</span> <span class="o">=</span> <span class="n">defaultTaskInp</span><span class="p">;</span>
<span class="p">};</span>
...
<span class="n">taskBtn</span><span class="o">.</span><span class="n">onclick</span> <span class="o">=</span> <span class="n">function</span><span class="p">()</span> <span class="p">{</span>
  ...
  <span class="p">};</span>
<span class="p">};</span>
<span class="n">newtaskbtn</span><span class="o">.</span><span class="n">addEventListener</span><span class="p">(</span><span class="s1">&#39;click&#39;</span><span class="p">,</span> <span class="n">moretaskrows</span><span class="p">);</span>
<span class="n">var</span> <span class="n">placeholder</span> <span class="o">=</span> <span class="s1">&#39;lol&#39;</span><span class="p">;</span>
</pre></div>
